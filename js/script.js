...
function displayIngrediant(data){
    ...
    for (var i = 0; i < data.length; i++) {
        cols += `
        <div onclick="GetIngradientMeals('${data[i].strIngredient}')" class="myIngred col-3 text-center d-flex justify-content-center align-items-center flex-column pb-5">
